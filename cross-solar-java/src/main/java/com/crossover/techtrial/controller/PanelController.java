...
public class PanelController {
  ...
  public ResponseEntity<List<DailyElectricity>> allDailyElectricityFromYesterday(
    ...
    List<HourlyElectricity> hourlyElectricityList = hourlyElectricityService.getAllHourlyElectricityByPanelIdAndDate(panel.getId(), LocalDateTime.now());
    ...
    for(HourlyElectricity hourlyElectricity:hourlyElectricityList) {
    	...
    	long hourlyEle = hourlyElectricity.getGeneratedElectricity();
    	long sum = hourlyElectricity.getGeneratedElectricity()*24;
    	double average = sum;
    	
    	dailyElectricity.setMin(hourlyEle);
    	dailyElectricity.setMax(hourlyEle*24);
